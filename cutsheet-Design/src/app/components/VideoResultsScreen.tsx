...
import { Wand2, ShieldCheck, Crosshair, Play, Eye } from "lucide-react";
...
export default function VideoResultsScreen() {
          ...
          <div className="w-full flex flex-col shrink-0 gap-[12px]">
            ...
            <div className="w-full h-[55vh] max-h-[420px] relative flex flex-col group shrink-0 rounded-2xl border border-white/[0.06] bg-black/20">
              ...
              <div className="flex-1 w-full relative flex items-center justify-center rounded-t-2xl overflow-hidden bg-zinc-900">
                ...
                />
                {/* Play Button Overlay */}
                <div className="absolute w-[64px] h-[64px] rounded-full bg-black/40 flex items-center justify-center backdrop-blur-sm border border-white/10 group-hover:bg-indigo-500/20 group-hover:border-indigo-500/30 transition-all cursor-pointer shadow-[0_0_20px_rgba(0,0,0,0.2)] group-hover:shadow-[0_0_30px_rgba(99,102,241,0.2)]">
                  <Play className="text-white/90 w-8 h-8 ml-1 group-hover:text-indigo-400 transition-colors" fill="currentColor" />
                </div>
              </div>
            ...
            {/* Section 3 — Second Eye Review Placeholder */}
